...
public class MovieAdapterDescription extends RecyclerView.Adapter<MovieViewHolder> {
    ...
    public MovieAdapterDescription(Context context, List<Movie> movie) {
        mContext = context;
        movies = movie;
    }
    ...
    public MovieViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = inflater.inflate(R.layout.movie_description, viewGroup, false);
    ...
    public void onBindViewHolder(MovieViewHolder holder, int position) {
        ...
        holder.description.setText(String.valueOf(movie.getDescription()));
