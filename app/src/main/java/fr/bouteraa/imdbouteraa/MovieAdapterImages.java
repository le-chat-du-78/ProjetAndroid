...
public class MovieAdapterImages extends RecyclerView.Adapter<MovieViewHolder> {
    ...
    public MovieAdapterImages(Context context, List<Movie> movie) {
        mContext = context;
        movies = movie;
    ...
    public MovieViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = inflater.inflate(R.layout.movie_images, viewGroup, false);
